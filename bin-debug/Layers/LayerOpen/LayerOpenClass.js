...
var LayerOpenClass = (function (_super) {
    ...
    */
    ...
    //注册用户登陆
    LayerOpenClass.prototype.userBtnTouch = function (e) {
        this.dispatchEvent(new EventManage(EventEnumerate.SELECT_COMPLETE, 'user'));
    };
    //访客登陆
    LayerOpenClass.prototype.touristsBtnTouch = function (e) {
     ...
     *   stateAlpha   alpha状态
     */
    LayerOpenClass.prototype.hiddenOut = function (exitTime, waitTime, stateAlpha) {
...
//# sourceMappingURL=LayerOpenClass.js.map